...
export class Backend implements backendInterface {
    ...
    async completeTutorial(arg0: bigint): Promise<void> {
    ...
    async getExercises(arg0: string | null): Promise<Array<Exercise>> {
        if (this.processError) {
            try {
                const result = await this.actor.getExercises(to_candid_opt_n1(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTutorials(arg0: string | null): Promise<Array<Tutorial>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTutorials(to_candid_opt_n1(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async solveExercise(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.solveExercise(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
